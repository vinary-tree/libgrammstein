...
impl CodeLanguage for JavaScript {
    ...
    fn stdlib_functions(&self) -> &[&str] {
        &[
            ...
            "some", "every", "includes", "indexOf", "join", "concat",
            "sort", "reverse", "flat", "flatMap",
            // Object methods
            "keys", "values", "entries", "assign", "freeze", "seal",
            "hasOwnProperty", "toString", "valueOf",
            // String methods
            "charAt", "charCodeAt", "split", "substring", "substr",
            "toLowerCase", "toUpperCase", "trim", "replace", "match",
            // Promise methods
...
mod tests {
    ...
    fn test_javascript_token_classification() {
        ...
        assert_eq!(js.classify_token("foo", "identifier"), TokenType::Identifier);
